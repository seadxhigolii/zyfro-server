    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignatureRequest", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SignatureRequest_Document_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Document",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignatureRequest_DocumentId",
                table: "SignatureRequest",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_SignatureRequest_RequestedById",
                table: "SignatureRequest",
                column: "RequestedById");

            migrationBuilder.CreateIndex(
                name: "IX_SignatureRequest_RequestedToId",
                table: "SignatureRequest",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowStep_AssignedToUserId",
                table: "WorkflowStep",
